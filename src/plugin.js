...
class ViuTools extends Plugin {
  ...
  constructor(player, options) {
    ...
    this.player.addChild('viuToolsComponent', this.options);
    ...
    this.player.ready(() => {
      ...
      if (this.player.getChild('viuToolsComponent')) {
        this.player
          .getChild('viuToolsComponent')
          .addChild('viuProcessInfo', this.options.info);
      }
      // 默认展示按钮
      const originActionArea = [
        this.player.getChild('viuToolsComponent').controlBar,
        this.player.getChild('viuToolsComponent').playToggle,
        this.player.getChild('viuToolsComponent').viuNextChip,
        this.player.getChild('viuToolsComponent').viuInfo,
        this.player.getChild('viuToolsComponent').viuSubtitle,
        this.player.getChild('viuToolsComponent').viuAdvance,
        this.player.getChild('viuToolsComponent').viuTopSubtitle
        // this.player.getChild("viuToolsComponent").viuFontSize,
      ];
      // 处理鼠标点击控制失效问题
      ...
      if (
        ...
        const viuNextChipBtn = this.player.getChild('viuToolsComponent')
          .viuNextChip;
      ...
      this.on('statechanged', (event, data) => {
        ...
        if (event.changes && event.changes.isTopSubtitleDisable) {
          ...
          const viuTopSubtitleBtn = this.player.getChild('viuToolsComponent')
            .viuTopSubtitle;
  ...
  checkTopSubtitleDisable(status) {
    ...
    const viuTopSubtitle = this.player.getChild('viuToolsComponent')
      .viuTopSubtitle;
  ...
  toggleInfo() {
    ...
    const viuInfo = this.player.getChild('viuToolsComponent').viuInfo;
  ...
  toggleSubtitle(step) {
    ...
    this.setComponentSelected(index);
    const viuSubtitle = this.player.getChild('viuToolsComponent').viuSubtitle;
  ...
  toggleFontSize() {
    ...
    this.setComponentSelected(index);
    const viuSubtitle = this.player.getChild('viuToolsComponent').viuFontSize;
  ...
  toggleNextChip() {
    if (this.player.getChild('viuToolsComponent')) {
      const viuNextChip = this.player.getChild('viuToolsComponent').viuNextChip;
    ...
    for (const i in this.state.panel) {
      if (this.state.panel[i]) {
        ...
        case 'isSubtileAreaSelected':
          this.player.getChild('viuToolsComponent').viuSubtitle.handleClick();
          break;
        case 'isInfoAreaSelected':
          this.player.getChild('viuToolsComponent').viuInfo.handleClick();
          break;
        case 'isFontSizeAreaSelected':
          this.player.getChild('viuToolsComponent').viuFontSize.handleClick();
          break;
        case 'isAdvanceAreaSelected':
          this.player.getChild('viuToolsComponent').viuAdvance.handleClick();
          break;
        default:
          break;
        }
...
ViuTools.defaultState = {};

// Include the version number.
ViuTools.VERSION = VERSION;

class ViuToolsComponent extends Component {
  constructor(player, options) {
...
ViuToolsComponent.prototype.options_ = {
  children: [
    'playToggle',
    'viuNextChip',
    'viuInfo',
...
videojs.registerComponent('viuToolsComponent', ViuToolsComponent);

// Register the plugin with video.js.
const registerPlugin = videojs.registerPlugin || videojs.plugin;

registerPlugin('viuTools', ViuTools);

export default ViuTools;
